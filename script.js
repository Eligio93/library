...
//         let toggleSwitch = '<label class="switch"><input type="checkbox" id="inputswitch"><span class="slider"><p>No</p><p>Yes</p></span></label>';
...
//         newDiv.innerHTML+=toggleSwitch;
//         if(myLibrary[i].read=="No"){
//             toggleSwitch=document.getElementById("inputswitch");
