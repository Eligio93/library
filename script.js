...
let toggleSwitch='<label class="switch"><input type="checkbox" class="toggle_switch"><span class="slider"><p>No</p><p>Yes</p></span></label>';
...
function displayBookCard(myLibrary){
    ...
    for(let i=0; i< myLibrary.length;i++){
        ...
        bookCard.innerHTML+=toggleSwitch;
